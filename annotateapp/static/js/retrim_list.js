...
function submit_repair(accepted) {
    ...
    var RT = evaluation_submitted - trial_begun;
    $.ajax({
        url : "/annotate/accept_result_retrim_list/", // the endpoint
        type : "POST", // http method
        data : {
			word_candidate: candidate_id, 
			evaluator: evaluator,
...
function fill_buffers()
{
	...
	if(buffer.length==0 & requests.length<=2){
		setTimeout(function(){
			worker_buffer1 = new Worker("/static/js/retrieve_retrim_trial_list.js");
			worker_buffer1.addEventListener('message', accept_new_item);
			requests.push(1);
			remove_request(1);
		}, 10);
		setTimeout(function(){
			worker_buffer3 = new Worker("/static/js/retrieve_retrim_trial_list.js");
			worker_buffer3.addEventListener('message', accept_new_item);
			requests.push(3);
			remove_request(3);
		}, 2000);
		setTimeout(function(){
			worker_buffer4 = new Worker("/static/js/retrieve_retrim_trial_list.js");
		...
		begin_trial();
		setTimeout(function(){
			worker_buffer2 = new Worker("/static/js/retrieve_retrim_trial_list.js");
